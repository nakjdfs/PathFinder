...
$(OBJ_DIR)/%.o: $(SRC_DIR)/%.c $(INC_FILES)
	...
	@printf "\r\33[2K pathfinder \033[33;1mcompile \033[0m$(<:$(SRC_DIR)/%.c=%) "
...
clean:
	@rm -rf $(OBJ_DIR)
	@printf "$(OBJ_DIR) in pathfinder \033[31;1mdeleted\033[0m\n"

uninstall:
	@make -sC libmx $@
	@rm -rf $(OBJ_DIR)
	@rm -rf pathfinder
	@printf "pathfinder \033[31;1muninstalled\033[0m\n"
